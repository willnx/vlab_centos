...
DEFINED = OrderedDict([
            ('VLAB_CENTOS_LOG_LEVEL', environ.get('VLAB_CENTOS_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'centos-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_CENTOS_IMAGES_DIR', environ.get('VLAB_CENTOS_IMAGES_DIR', '/images')),
